...
network_configuration=$(
  jq -n \
    ...
    --arg infra_dns "192.168.101.1,1.1.1.1,1.0.0.1" \
    ...
    --arg deployment_dns "192.168.16.1,1.1.1.1,1.0.0.1" \
    ...
    --arg services_dns "192.168.20.1,1.1.1.1,1.0.0.1" \
    ...
    --arg dynamic_services_dns "192.168.24.1,1.1.1.1,1.0.0.1" \
